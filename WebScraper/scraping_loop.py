...
scoreline = ["0100", "0000", "0001", "0200", "0101", "0002", "0201", "0202", "0102", "0300", "0303", "0003", "0301",
             "0103", "0302", "0203", "0400", "0004", "0401", "0104", "0402", "0204", "0500", "0005", "0501", "0105",
             "0502", "0205", "-1-H", "-1-D", "-1-A"]
...
def scraping_loop():
    ...
    temptime = dt.now(hk)
    print("Data Scraped at:" + temptime.strftime('%Y-%m-%d_%H-%M-%S') )
    print("")
    print("")
    return match_count
...
def main():
    schedule.every(1).second.do(scraping_loop)
    while True:
